  ...
  <div class="box">
    <div class="box2">
      <div class="figure">
        ...
        <div class="back">
          <el-button @click="to" type="primary">返回首页</el-button>
        </div>
      </div>
    </div>
  </div>
...
.moon:after {
  ...
  box-shadow: -30px -50px 0 20px, 50px -30px 0 -8px, 50px -90px 0 2px, 100px -90px 0 0, 100px -40px 0 25px, 150px -15px 0 0, 240px 15px 0 4px, 230px -80px 0 2px, 200px -20px 0 16px, 350px 0 0, 320px -50px 0 20px, 400px -30px 0 -8px, 400px -90px 0 2px
}
